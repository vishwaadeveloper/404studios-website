  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        ...
        {/* Our Specialty */}
        <LazySection className="py-12 sm:py-16 md:py-20 lg:py-28">
          <div className="container px-4 sm:px-6 md:px-8 mx-auto">
            <FadeInSection>
                  ...
                  <SimpleCard className="h-full">
                    <CardContent className="p-4 sm:p-6">
                      <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
                        <div className="rounded-full bg-primary/10 text-primary p-2.5 sm:p-3 border border-primary/20">
                          {step.icon}
                        </div>
        ...
        {/* Why Choose Us */}
        <LazySection className="py-12 sm:py-16 md:py-20 lg:py-28 bg-muted/50">
          <div className="container px-4 sm:px-6 md:px-8 mx-auto">
            <FadeInSection>
              <div className="text-center mb-8 sm:mb-12 md:mb-16">
        ...
        <LazySection className="py-12 sm:py-16 md:py-20 lg:py-28">
          <div className="container px-4 sm:px-6 md:px-8 mx-auto">
            <FadeInSection>
              <SimpleCard className="max-w-6xl mx-auto">
                <div className="p-6 sm:p-8 md:p-12 lg:p-16 text-center space-y-6 sm:space-y-8">
    ...
    <SimpleCard className="h-full">
      <CardContent className="p-4 sm:p-6 md:p-8">
        <div className="flex flex-col space-y-4 sm:space-y-6 h-full text-center sm:text-left">
          <div className="rounded-full bg-primary/10 text-primary p-3 sm:p-4 w-fit border border-primary/20 mx-auto sm:mx-0">
            {icon}
          </div>
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold">{title}</h3>
          <p className="text-muted-foreground leading-relaxed flex-grow text-sm sm:text-base">{description}</p>
        </div>
      </CardContent>
    </SimpleCard>
  )
